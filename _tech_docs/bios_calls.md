...
| 2 | スロット/システム | ENASLT (#0024) | スロット選択してページに反映 | HL:書き込み番地 A: bit7=拡張スロット指定時1 bit2・3 拡張スロット番号、bit0・1 基本スロット番号 割り込みは禁止されて戻る。 | なし | 全て | BIOS, BASIC, RAMのページ切替に利用。                          |
...
| 9 | 文字入出力 | POSIT (#00C6/MAIN) | カーソル移動 | H:カーソルのX座標, L:カーソルのY座標 | なし | AF | カーソル位置を直接設定する。※ 左上の座標は 1,1 。                        |
